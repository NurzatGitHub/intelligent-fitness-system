...
# -----------------------------
# 33 MediaPipe landmarks -> your 18 points
# Each point: (x, y, visibility) in normalized coords [0..1]
# -----------------------------
def to_points_18(lm33) -> List[Tuple[float, float, float]]:
    ...
    # mouth = mean of mouth_left (9) and mouth_right (10)
    mouth_l = p(9)
    mouth_r = p(10)
    mouth = (
    ...
    return [
        ...
        p(23), p(24),  # hips
        p(25), p(26),  # knees
        p(27), p(28),  # ankles (kept in format but NOT required for features)
        p(31), p(32),  # feet
    ]


# -----------------------------
# Feature extraction from 18 points
# Features: [min_elbow, diff, body_line, elbow_ratio, left_elbow, right_elbow]
# body_line uses chest-hip-knee (more stable than ankle for push-up)
# -----------------------------
